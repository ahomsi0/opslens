...
export function ConnectUptimeRobotDialog({
  open,
  onOpenChange,
}: {
  open: boolean;
  ...
  const [name, setName] = useState("UptimeRobot");
      ...
      <DialogContent className="max-w-md">
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--color-fg-muted)]">
            Paste your UptimeRobot API key. We&apos;ll pull every monitor on
            the account and surface their up/down status alongside your other
            projects.
          </p>
        </div>
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <a
                href="https://dashboard.uptimerobot.com/integrations/api"
                target="_blank"
